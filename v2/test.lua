...
function HiUser()
    if GetUser() ~= nil then
        if GetGroup() == developer or GetGroup() == Developer or GetGroup() == ScriptsDeveloper or GetGroup() == scriptsdeveloper or GetGroup() == Scriptsdeveloper then
        ...
        elseif GetGroup() == LocalSupport or GetGroup() == localsupport or GetGroup() == Localsupport then
